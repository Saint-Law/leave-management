    ...
    public class LeaveRequestController : Controller
    {
        ...
        public async Task<ActionResult> ApprovedRequest(int id)
        {
            try
            {
                ...
                var alloction = await _leaveAllocRepo.GetLeaveAllocationsByEmployeeAndType(employeeid, leaveTypeId);
                ...
                await _leaveAllocRepo.Update(alloction);
        ...
        public async Task<ActionResult> CancelledRequest(int id)
        {
            var leaveRequest = await _leaveRequestRepo.FindById(id);
